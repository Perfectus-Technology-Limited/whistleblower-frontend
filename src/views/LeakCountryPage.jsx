...
function LeakCountryPage({country}) {
  ...
  useEffect(() => {
    fetchLeaks()
  }, [pageSize, currentPage, country,searchKey])

  const fetchLeaks = async () => {
    try {
      setIsLeakListLoading(true)
      const endpoint = `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/leaks/country?page=${currentPage}&limit=${pageSize}&country=${country}&search=${searchKey}`
...
export default LeakCountryPage
